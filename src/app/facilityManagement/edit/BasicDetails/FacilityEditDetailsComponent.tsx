                    ...
                    <div className="facility-basic-details mrg-top-40 custom-border">
                        ...
                        <div className="input-container mrg-top-10">
                            ...
                            <Field
                                ...
                                fullWidth autoComplete="off" id='input_facility_edit_timezone'>
                    ...
                    <div className="facility-other-details mrg-top-10  custom-border">
                        ...
                        <div className="input-container">
                            <Field SelectProps={showDropDownBelowField} variant="outlined" name="conditional_rates.overtime.hours"
                                type={"text"} component={TextField} select label="OT Hours (hr/day)" fullWidth
                                autoComplete="off" id='input_facility_edit_conditional_rates.overtime.hours'>
                            ...
                            {fileUpload?.wrapper.length > 0 ? fileUpload?.wrapper?.map((item: any, index: any) => {
                                return (
                                    <div className="attachments">
                                        <div className="custom_file">
                                            <div className="d-flex">
                                                <div className="mrg-left-0 mrg-top-10"> <Tooltip title="Preview Facility Icon">{item?.file?.type === "image/jpg" || item?.file?.type === "image/png" || item?.file?.type === "image/jpeg" ? <img src={item?.file?.base64} alt="" style={{ height: "100px", width: "100px" }} onClick={() => previewFile(index)} /> : <img src={PdfIcon} alt="" style={{ height: "100px", width: "100px" }} onClick={() => previewFile(index)} />}</Tooltip></div>
                                                <div className="file_details mrg-left-20">
                                                </div>
                                            </div>
