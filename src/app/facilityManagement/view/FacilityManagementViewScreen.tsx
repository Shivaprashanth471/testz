...
const FacilityManagementViewScreen = (props: any) => {
  ...
  return (
    <div className="pdd-30 screen">
      {!isLoading && (
        <div className="facility_view_details">
              ...
              <AccordionDetails>
                <div className={classes.root}>
                  {facilityMembers?.length > 0 ? (
                    facilityMembers?.map((item: any, index: any) => {
                      return (
                        <div className={index !== 0 ? "mrg-top-30" : "mrg-top-10"}>
              ...
              <AccordionDetails>
                <div className={classes.root}>
                  {shiftDetails?.length > 0 ? (
                    shiftDetails?.map((item: any, index: any) => {
                          ...
                          <div className="">
                            <div className="d-flex">
                              ...
                              <div className="flex-1">
                                ...
                                <p>{CommonService.durationBetweenTimeStamps(start_time_to_get_duration, end_time_to_get_duration)}</p>
                              </div>
                            </div>
                            <div className="d-flex">
                              <div className="flex-1">
