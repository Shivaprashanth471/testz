    ...
    return (
        <>
            <div className={"facility-list screen crud-layout pdd-30 pdd-top-10"}>
                ...
                <FacilityFiltersComponent dateRange={dateRange} setDateRange={setDateRange}
                                          selectedRegions={selectedRegions} setSelectedRegions={setSelectedRegions}
                                          resetFilters={resetFilters} setStatus={setStatus} regionList={regionList}
                                          status={status}/>
                                        ...
                                        {list?.table.data.map((row: any, rowIndex: any) => {
                                            return (
                                                <TableRow role="checkbox" tabIndex={-1} key={"row-" + rowIndex}
                                                    ...
                                                    <TableCell
                                                        className="mat-td mat-td-facility-name">{row["facility_name"]}</TableCell>
                                                    <TableCell
                                                        className="mat-td mat-td-region-name">{row?.address["region_name"]}</TableCell>
                                                    <TableCell
                                                        className="mat-td mat-td-phone-number">{row["phone_number"]}</TableCell>
