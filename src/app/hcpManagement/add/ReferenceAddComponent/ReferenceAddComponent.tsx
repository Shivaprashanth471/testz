...
const ReferenceAddComponent = ({
  ...
  const handleDeleteClick = (referenceId: string) => {
    ...
    const index = references.findIndex(
      (reference: any) => reference.tempId === referenceId
    );
              ...
              <Form className={"form-holder"}>
                <div className="input-container">
                  <Field
                    ...
                    autoComplete="off"
                    id="input_hcp_add_reference_name"
                  />
                  ...
                  <Field
                    ...
                    autoComplete="off"
                    id="input_hcp_add_reference_job"
                  />
                </div>
                ...
                <div className="input-container">
                  <Field
                    ...
                    autoComplete="off"
                    id="input_hcp_add_reference_number"
                  />
                  ...
                  <Field
                    ...
                    autoComplete="off"
                    id="input_hcp_add_reference_email"
                  />
                </div>
