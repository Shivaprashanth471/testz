...
const ShiftCheckInComponent = (props: PropsWithChildren<ShiftCheckInComponentProps>) => {
    ...
    return <div className={classes.paper}>
        ...
        <DialogActions className="mrg-top-20">
            ...
            <Button type={"submit"} onClick={handleShiftCheckIn} disabled={isSubmitting}
                className={isSubmitting ? "has-loading-spinner submit" : "submit"} variant={"contained"} color="secondary" autoFocus>
