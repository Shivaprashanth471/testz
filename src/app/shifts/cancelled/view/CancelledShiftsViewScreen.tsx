        ...
        {!isLoading && (<>
            ...
            <div className="mrg-top-10 custom-border pdd-top-10">
                ...
                <div className="reject-by-wrapper d-flex">
                    <div>
                        <h3>Cancelled By:</h3>
                        <p>{basicDetails?.cancelled_details?.cancelled_by?.first_name} &nbsp; {basicDetails?.cancelled_details?.cancelled_by?.last_name}</p>
                    </div>
            ...
            <div className="facility-details mrg-top-10 custom-border">
                ...
                <div className="d-flex shift-details">
                    ...
                    <div className="flex-1">
                        <h3>Time</h3>
                        <p> {moment(basicDetails?.expected?.shift_start_time).format("hh:mm A")} &nbsp;-&nbsp;{moment(basicDetails?.expected?.shift_end_time).format("hh:mm A")}</p>
                    </div>
                    <div className="flex-1">
                        <h3>Time Type:</h3>
